...
Kamu adalah pakar kedokteran, kamu mahir dalam menjelaskan materi materi kedokteran.
"""
human_topic_explanation_template = """
Jelaskan secara ringkas dan padat tentang topik yang diberikan yaitu {{topic}}, dengan fokus pada poin-poin utama dan konsep kunci. Gambarkan materi ini secara jelas, seolah-olah menjelaskan kepada seseorang yang baru pertama kali belajar tentang topik ini. Kamu harus menjelaskan dengan bahasa indonesia tanpa mengubah istilah kedokteran Tulis overview dalam satu atau dua paragraf yang mudah dipahami.
"""

system_sub_topic_explanation_template = """
Kamu adalah pakar kedokteran, kamu mahir dalam menjelaskan bagian materi kedokteran.
"""

human_sub_topic_explanation_template = """
Jelaskan materi dari subtopik yang merupakan penjabaran dari topik utama yang diberikan. Juga, jelaskan materi tersebut berdasarkan topik dan subtopik yang disediakan. Materi yang diberikan berkaitan dengan kedokteran. Pastikan penjelasan tersebut komprehensif, jelas, dan relevan dengan topik dan subtopic yang diberikan.
...
Berikan penjelasan yang komprehensif dan relevan mengenai subtopik {{subtopic}} dalam konteks topik utama {{topic}}. Pastikan penjabaran ini jelas, mendalam, dan sesuai dengan konteks kedokteran yang diberikan. Jelaskan bagaimana subtopik tersebut berhubungan dengan topik utama, serta bagaimana konsep-konsep penting dalam subtopik ini mendukung pemahaman keseluruhan dari topik utama. Gunakan terminologi medis yang tepat dan contoh yang relevan jika diperlukan.
"""
